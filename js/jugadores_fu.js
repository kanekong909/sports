...
fetch("./../data/data.json")
    ...
    function obtenerCategoria(posiciones) {
        ...
        if (posicion.includes('lateral') || posicion.includes('central') || posicion.includes('defensa')) return 'Defensas';
        if (posicion.includes('mediocentro') || posicion.includes('mediocampista') || posicion.includes('centrocampista')) return 'Mediocampistas';
        if (posicion.includes('delantero') || posicion.includes('extremo')) return 'Delanteros';
    ...
    Object.entries(categorias).forEach(([categoria, jugadoresCategoria]) => {
        ...
        // Contenedor de grid para esta categoría
        const gridCategoria = document.createElement("div");
        gridCategoria.classList.add("jugadores-grid");
        ...
        seccion.appendChild(gridCategoria);
